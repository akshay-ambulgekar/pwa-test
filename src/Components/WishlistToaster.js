...
export { WishlistToaster };

export default function showWishlistToaster() {
    ...
    <div className="w-[var(--width)] py-2">
      <div className="gap-2">
        <div className="flex justify-center items-center grow gap-2">
          ...
          <p className={"all-caps-12 text-center uppercase custom-text-grey900 "}> Added to Favourites </p>
        </div>
      </div>
    </div>
  )
